...
const TESTS = [
  ...
  { id:'t_charge_battery', label:'電池切れの本体を付属品で十分に充電していただく', turns:5, wait:'付属品で充電し、起動が安定するまで待っていただいています。', needsDevice:true },
  { id:'t_charge_ac',  label:'パソコンのUSBから付属ACアダプタへ給電元を替えていただく', turns:2, wait:'付属ACアダプタへ替え、残量の変化を見ていただいています。', needsDevice:true },
...
const REMEDIES = {
  ...
  power: [
    ...
    { id:'r_low_battery_charge', label:'電池残量の低下が原因だったことをご説明し、付属品で十分に充電していただく', sub:'対応品で充電し、起動と通信の安定を確認する', kind:'resolve', needsTest:'t_charge_battery' },
    { id:'r_ac_charge', label:'パソコンからの給電不足だったことをご説明し、付属ACアダプタで充電いただく', sub:'給電元だけを安全な方法へ替える', kind:'resolve', needsTest:'t_charge_ac' },
...
},
{
  ...
  tests:{t_charge_battery:{text:'付属のケーブルとアダプタでしばらく充電したら、起動したままになり通信もできました。',fact:{text:'対応する付属品で充電すると起動と通信が安定した',hot:['power'],out:['fup','devices','geo_block','heavy','device_side','device_net','location','carrier','coverage','sim','hardware','provision','logistics']},solves:true}},
...
},
{
  ...
  tests:{t_charge_ac:{text:'付属ACアダプタへ替えたら、通信中でも残量が増え始めました。',fact:{text:'付属ACアダプタでは給電が消費を上回った',hot:['power'],out:['fup','devices','geo_block','heavy','device_side','device_net','location','carrier','coverage','sim','hardware','provision','logistics']},solves:true}},
